...
from IQL import IQL
from double_distribut_IQL import Double_distribution_IQL
from distribute_IQL import Distribution_IQL
...
if __name__ == "__main__":
    ...
    if args.policy == 'IQL':
        policy = IQL(**kwargs)
    elif args.policy == 'dIQL':
        policy = Distribution_IQL(**kwargs)
    elif args.policy == 'ddIQL':
        policy = Double_distribution_IQL(**kwargs)
